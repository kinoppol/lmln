...
$PRE = [
    ...
    ['q' => 'ผลลัพธ์จาก ls -l บรรทัดหนึ่งขึ้นต้นด้วยตัวอักษร d หมายความว่าอย่างไร', 'o' => ['เป็นไฟล์ที่ถูกลบ', 'เป็นไดเรกทอรี', 'เป็นไฟล์ซ่อน', 'เป็นไฟล์ที่รันได้'], 'a' => 1, 'e' => 'ตัวอักษรแรกบอกชนิด: d = directory, - = ไฟล์ธรรมดา, l = ลิงก์'],
...
$LESSON_QUIZ_SOURCE = [
    1 => [['bank' => 'PRE', 'i' => 0], ['bank' => 'PRE', 'i' => 1], ['bank' => 'PRE', 'i' => 7]],
    2 => [
    ...
    7 => [
        ['bank' => 'POST', 'i' => 8],
        ['bank' => 'NEW', 'q' => ['q' => 'หากไม่แน่ใจว่าคำสั่งหนึ่งมี option อะไรบ้าง ควรทำอย่างไรเป็นอันดับแรก', 'o' => ['ลองพิมพ์สุ่มดู', 'เปิดดูด้วย man <คำสั่ง> หรือ <คำสั่ง> --help', 'ถามเพื่อนอย่างเดียว', 'ไม่ต้องดู ใช้ตามที่จำได้'], 'a' => 1, 'e' => 'man และ --help เป็นคู่มือที่ติดมากับระบบ ใช้ได้แม้ออฟไลน์']],
    ...
    9 => [['bank' => 'PRE', 'i' => 9], ['bank' => 'POST', 'i' => 6], ['bank' => 'POST', 'i' => 7]],
];
